...
factor9 = st.radio('Do you have chest pain on the left side? (您是否左胸痛？)', ['Yes (是)', 'No (否)', 'Not Sure (不清楚)'], index = None)
factor10 = st.radio('Do you have hypertension? (您是否有高血压？)', ['Yes (是)', 'No (否)', 'Not Sure (不清楚)'], index = None)
factor11 = st.radio('Do you have dyslipidemia? (您是否有血脂异常？)', ['Yes (是)', 'No(否)', 'Not Sure(不清楚)'], index = None)
factor12 = st.radio('Do you have diabetes? (您是否有糖尿病？)', ['Yes (是)', 'No(否)', 'Not Sure(不清楚)'], index = None)
factor13 = st.radio('Do you have chronic lung disease? (您是否有慢性肺部疾病？)', ['是', '否', '不清楚'], index = None)
factor14 = st.radio('Do you have liver disease? (您是否有肝脏疾病？)', ['是', '否', '不清楚'], index = None)
factor15 = st.radio('Do you have heart attack? (您是否有心脏病？)', ['是', '否', '不清楚'], index = None)
factor16 = st.radio('Do you have stroke? (您是否有中风？)', ['是', '否', '不清楚'], index = None)
factor17 = st.radio('Do you have kidney disease? (您是否有肾脏疾病？)', ['是', '否', '不清楚'], index = None)
factor18 = st.radio('Do you have gastric or digestive disease? (您是否有胃部或消化系统疾病？)', ['是', '否', '不清楚'], index = None)
factor19 = st.radio('Do you have emotional or mental issue? (您是否有情感及精神方面问题？)', ['是', '否', '不清楚'], index = None)
factor20 = st.radio('Do you have memory-related diseases? (您是否有与记忆相关疾病？)', ['是', '否', '不清楚'], index = None)
factor21 = st.radio('Do you have arthritis or rheumatism? (您是否有关节炎或风湿？)', ['是', '否', '不清楚'], index = None)
factor22 = st.radio('Do you have asthma? (您是否有哮喘？)', ['是', '否', '不清楚'], index = None)
factor23 = st.radio('Have you experienced a traffic accident or a major injury accident? (您是否有经历过交通事故或重大意外伤害？)', ['是', '否', '不清楚'], index = None)
factor24 = st.radio('Have you been diagnosed with glaucoma? （您是否有确诊青光眼？）', ['是', '否', '不清楚'], index = None)
factor25 = st.radio('How's your hearing? (您的听力如何？)', ['非常好', '很好', '好', '一般', '不好', '不清楚'], index = None)
